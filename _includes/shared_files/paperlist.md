...
# 2025
- Yiwei Guo, Bohan Li, Hankun Wang, Zhihan Li, Shuai Wang, **Xie Chen**, Kai Yu. *"AHAMask: Reliable Task Specification for Large Audio Language Models without Instructions"*. In Proc. AAAI, 2025 
- Xiaoqian Liu, Xiyan Gui, Zhengkun Ge, Yuan Ge, Chang Zou, Jiacheng Liu, Zhikang Niu, Qixi Zheng, Chen Xu, **Xie Chen**, Tong Xiao, JingBo Zhu, Linfeng Zhang. *"WaveEx: Accelerating Flow Matching-based Speech Generation via Wavelet-guided Extrapolation"*. In Proc. AAAI, 2025.
